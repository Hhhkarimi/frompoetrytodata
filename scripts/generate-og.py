...
CARDS = {
    ...
    'og-research.png': ('هشت پژوهش داده‌محور', 'از تحول مضامین تا جغرافیای شعر و چرخه عمر واژگان', '#0f766e'),
    ...
    'og-intertextuality.png': ('شبکه بینامتنیت شاعران', 'قرابت عبارتی، واژگانی و موضوعی در تاریخ شعر فارسی', '#9f2f38'),

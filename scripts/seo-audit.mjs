...
const required = [
  ...
  'api/computational-aesthetics.json', 'research/computational-aesthetics/index.html', 'downloads/computational-aesthetics.csv', 'downloads/computational-aesthetics.json',
